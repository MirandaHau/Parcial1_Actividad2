...
#Leer el archivo NDA.pdf y calcular el hash
nda = 'NDA.pdf'
...
# La AC verifica la firma de Alice usando la clave pública de Alice
...
#La AC firma el hash con su clave privada
sAc = pow(hM, dAc, nAc)  # Firma el hash de manera manual usando la clave privada de la AC
print('\nFirma de la AC:', sAc)

#Bob verifica la firma de la AC usando la clave pública de la AC
